...
function objectURLToBlob(url: any, callback: any) {
...
function getStringFromCharCode(dataView: any, start: any, length: any) {
  var str = '';
  var i;
...
function getOrientation(arrayBuffer: any) {
